...
const CommissionQuestion: React.FC<CommissionQuestionProps> = ({
  ...
  return (
    <div className="flex flex-col items-center gap-5">
      <p>
        {personName} earns <b>{commission}%</b> interest for every house they
        sell. If they sell <b>{numberOfSales}</b> house(s) for{" "}
        <b>${price} each</b>, how much commission did they earn?
      </p>

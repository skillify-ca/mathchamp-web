...
export const hotDog: Food = {
  ...
  unitRevenue: 4,
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/emojis/57508/hot-dog-emoji-clipart-original.svg",
  prepTime: 1,
...
export const soupDumplings: Food = {
  ...
  unitRevenue: 10,
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/3390805/xiaolongbao-food-clipart.svg",
  prepTime: 4,
...
export const curry: Food = {
  ...
  unitRevenue: 15,
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/36257/cooking-curry-clipart.svg",
  prepTime: 6,
...
export const kebab: Food = {
  ...
  unitRevenue: 6,
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/35112/barbecue-barbeque-bbq-clipart.svg",
  prepTime: 6,
  qtyProducedPerWorkerHour: 30,
};
...
export const okonomiyaki: Food = {
  ...
  unitRevenue: 12,
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/3386659/okonomiyaki-japanese-food-clipart.svg",
  prepTime: 6,
...
export const smallTruck: Truck = {
  ...
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/25675/222-1033-traditional-culinary-vector-up-clipart.svg",
};
...
export const mediumTruck: Truck = {
  ...
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/840327/food-truck-clipart.svg",
};
...
export const largeTruck: Truck = {
  ...
  imageUrl:
    "https://creazilla-store.fra1.digitaloceanspaces.com/cliparts/1795498/food-truck-clipart.svg",
};
